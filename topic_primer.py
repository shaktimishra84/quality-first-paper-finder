...
PROMPT_INSTRUCTIONS = (
    ...
    "FIRST, silently normalize the user's topic before reasoning: expand clinical "
    "shorthand and abbreviations to their full term (e.g. 'hydrocort' -> "
    "'hydrocortisone', 'methylpred' -> 'methylprednisolone', 'abx' -> "
    "'antibiotics'), and correct obvious misspellings of drugs, conditions, and "
    "procedures. Base every field below on the normalized topic.\n"
    "When the topic centers on a specific drug, treat the exact drug and its "
    "clinically equivalent forms as direct_synonyms, put the drug CLASS in "
    "parent_topics (e.g. 'corticosteroids', 'glucocorticoids'), and list sibling "
    "drugs of the same class in parallel_topics (e.g. for hydrocortisone: "
    "dexamethasone, methylprednisolone, prednisolone, prednisone). Do the analogous "
    "thing for a specific condition or procedure.\n\n"
    "Required fields:\n"
    ...
    "  and a reason.\n"
    "- query_expansion_terms: 8-20 alternate terms PubMed should also search: "
    "  synonyms, abbreviations, MeSH-style alternatives, eponyms and "
    "  historical/legacy disease names, common British/American spelling "
    "  variants, and closely related terms. Favour recall — include alternate "
    "  terminology a relevant paper might be indexed under even if it is less "
    "  common today (e.g. older eponymous names). Still omit anything you are "
    "  not confident is the same clinical entity.\n"
